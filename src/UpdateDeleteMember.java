...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(UpdateDeleteMember.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel10.setText("National Number (Unique Number)");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String nationalnumber=jTextField9.getText();
        String age=jTextField10.getText();
        String amount=jTextField11.getText();
        try {
        
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps=con.prepareStatement("update member set name=?,mobilenumber=?,email=?,fathername=?,mothername=?,nationalnumber=?,age=?,amount=? where id=?");
            ps.setString(1, name);
            ps.setString(2, mobilenumber);
            ps.setString(3, email);
            ps.setString(4, fathername);
            ps.setString(5, mothername);
            ps.setString(6, nationalnumber);
            ps.setString(7, age);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(a==0)
        {
          ...
          try 
          {
           ...
           JOptionPane.showMessageDialog(null, "Succcessgully Deleted");
              setVisible(false);
              new UpdateDeleteMember().setVisible(true);
          }
          catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new UpdateDeleteMember().setVisible(true));
    }
